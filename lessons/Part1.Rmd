...
🔔 What tasks would you like to use R for? How do you envision using R in your research or class projects? **Answer in the Zoom poll.**
...
### 🥊Challenge 3: Manipulating vectors
...
### 🥊Challenge 4: Multiple ways to create vectors
...
-   We used the following functions: `ls()`, `rm()`, `c()`, `length()`, and `seq()`. To see how to use them use **?** followed by the function name (or Google them)
