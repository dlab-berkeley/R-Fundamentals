...
3.  Use functions from the `tidyverse` package to subset variables and rows in a data frame
...
### 🥊Challenge 2: Import a csv file and explore the data
...
### 🥊Challenge 3: Subsetting columns
...
### 🥊 Challenge 5: Combining filter and select
